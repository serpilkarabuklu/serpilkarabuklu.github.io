...
<img src="/images/article2.png" width="20" style="vertical-align:middle; margin-right:5px;"> __May 2026__Our [new preprint](https://arxiv.org/abs/2604.27232) is out! We introduce ASL-MTP and use it to analyze how current models handle key linguistic phenomena in ASL. Our findings show that models rely heavily on manual cues and often miss crucial nonmanual information—highlighting a gap in modeling simultaneous structure in sign languages. This is a step toward more linguistically grounded evaluation of multimodal language models. The project is started with [Shester's] (https://shesterg.github.io/) idea and design, and huge shout-out to all my collaborators!
